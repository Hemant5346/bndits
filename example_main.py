...
from tokyo_dataset import get_tokyo_dataset
...
def main(_):
  ...
  sampled_vals = get_tokyo_dataset()
  ...
  algos = [
      ...
      FixedPolicySampling('fixed1', np.repeat(1/276, 276), hparams),
      FixedPolicySampling('fixed2', np.repeat(1/276, 276), hparams),
